...
import (
	...
	"github.com/heycart/heycart-cli/internal/changelog"
...
func generateProjectSchema() error {
	...
	if err := r.AddGoComments("github.com/heycart/heycart-cli", "./shop"); err != nil {
		return err
	}
...
func generateExtensionSchema() error {
	...
	if err := r.AddGoComments("github.com/heycart/heycart-cli", "./extension"); err != nil {
		return err
	}

	if err := r.AddGoComments("github.com/heycart/heycart-cli", "./internal/changelog"); err != nil {
		return err
	}
	...
	if err := os.WriteFile("extension/heycart-extension-schema.json", bytes, 0o644); err != nil {
		return err
	}
