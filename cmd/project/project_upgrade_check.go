...
import (
	...
	account_api "github.com/heycart/heycart-cli/internal/account-api"
...
var projectUpgradeCheckCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		var cfg *shop.Config
		var err error
		var heycartVersion *version.Version
		...
		for _, v := range versions {
			...
			if ver.LessThan(heycartVersion) {
				continue
			}
		...
		updates, err := account_api.GetFutureExtensionUpdates(cmd.Context(), heycartVersion.String(), selectedVersion, extensionNames)
		if err != nil {
			return err
		}
