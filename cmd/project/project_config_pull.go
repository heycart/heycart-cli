...
var projectConfigPullCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, _ []string) error {
		logging.FromContext(cmd.Context()).Warnf("This command is deprecated and will be removed in the future. Please use Fixture Bundle instead https://developer.heycart.net/docs/resources/tooling/fixture-bundle/")
